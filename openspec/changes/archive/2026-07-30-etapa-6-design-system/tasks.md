...
- [x] 6c-5.2 Run `pnpm test:e2e` against local dev server — all smoke tests pass (requires running dev server with valid .env.local)
- [x] 6c-5.3 Static analysis pass: grep `src/` for `text-red-600`, `text-green-600`, `#d97706`, `bg-amber-600` — remaining matches not in scope for PR 6c
